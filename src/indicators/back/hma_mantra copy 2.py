...
def plot_signals_with_strength(data: pd.DataFrame, ticker: str, save_path: str = None) -> None:
    ...
    try:
        ...
        ma5_min = float(ma5_price.min()) if hasattr(ma5_price.min(), 'item') else ma5_price.min()
        ma20_min = float(ma20_price.min()) if hasattr(ma20_price.min(), 'item') else ma20_price.min()
        ma60_min = float(ma60_price.min()) if hasattr(ma60_price.min(), 'item') else ma60_price.min()
        ma120_min = float(ma120_price.min()) if hasattr(ma120_price.min(), 'item') else ma120_price.min()
        ma200_min = float(ma200_price.min()) if hasattr(ma200_price.min(), 'item') else ma200_price.min()
        ma_min = min(ma5_min, ma20_min, ma60_min, ma120_min, ma200_min)

        ma5_max = float(ma5_price.max()) if hasattr(ma5_price.max(), 'item') else ma5_price.max()
        ma20_max = float(ma20_price.max()) if hasattr(ma20_price.max(), 'item') else ma20_price.max()
        ma60_max = float(ma60_price.max()) if hasattr(ma60_price.max(), 'item') else ma60_price.max()
        ma120_max = float(ma120_price.max()) if hasattr(ma120_price.max(), 'item') else ma120_price.max()
        ma200_max = float(ma200_price.max()) if hasattr(ma200_price.max(), 'item') else ma200_price.max()
        ...
        vol_max = float(data['Volume'].max()) if hasattr(data['Volume'].max(), 'item') else data['Volume'].max()
